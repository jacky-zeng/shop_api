...
class CreateGoodsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('goods', function (Blueprint $table) {
            ...
            $table->string('sku_detail')->nullable()->comment('规格详情，json格式');
            ...
            $table->tinyInteger('is_must_check')->default(0)->comment('是否必选商品   1-是  0-否 默认 0');
            $table->tinyInteger('shelves_status')->default(1)->comment('上架状态 1-上架 0-下架 默认 1（后台管理）');
            $table->tinyInteger('sale_status')->default(1)->comment('售卖状态 1-在售 2-停售 默认 1（商家管理）');
